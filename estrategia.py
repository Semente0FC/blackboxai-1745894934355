                ...
                try:
                    ...
                    try:
                        ...
                        condicoes_compra = [
                            ...
                            float(stoch_k[-1]) < 20 and float(stoch_k[-1]) > float(stoch_k[-2]),  # Estocástico subindo do sobrevendido
                        ...
                        condicoes_venda = [
                            ...
                            float(stoch_k[-1]) > 80 and float(stoch_k[-1]) < float(stoch_k[-2]),  # Estocástico caindo do sobrecomprado
